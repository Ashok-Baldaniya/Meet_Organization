    ...
    <>
      ...
      <form className={styles.form} onSubmit={handleCreateMeeting}>
        ...
        <fieldset className={styles.fieldset}>
          ...
          <input className={styles.time} value={startTime} min={minTimeValue} max={maxTimeValue} step="1800" onChange={(e) => setStartTime(e.target.value)} />
        </fieldset>

        <fieldset className={styles.fieldset}>
          <label className={styles.label} htmlFor="endTime">Final</label>
          <input className={styles.time} value={endTime} min={minTimeValue} max={maxTimeValue} step="1800" onChange={(e) => setEndTime(e.target.value)} />
        </fieldset>
